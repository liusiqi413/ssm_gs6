...
<head>
    ...
    <style>
        ...
        body {background-image:url("${pageContext.request.contextPath}/static/layui/images/timg.gif");background-repeat:no-repeat;background-size:100% 100%;
            ...
            <div class="layui-form login-form">
                <form class="layui-form" action="">
                    <div class="layui-form-item logo-title">
                        <h1>邢台学院毕业生就业管理后台登录</h1>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-icon layui-icon-username" for="username"></label>
                        <input type="text" name="username" id="username" lay-verify="required|account" placeholder="用户名" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-item">
